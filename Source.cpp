...
Суть проги: Человек Х, читал книгу/смотрел кино/делал дз, увидел незнакомое английское слово, надо выучить.
            ...
            Далее он может с этим делать следующее:         
			есть меню с функциями 1)добавить слово (добавляет английское и перевод)
...
Не знаю: 1) как удалять слово(строку) из файла (вот тут мне нужно очень помочь:( ). (Я думала создать из 
		 ...
		 2) как сделать режим изучения 
		 (как код написать, а логика вот:     1)из файла(базы) выдается поочередно слово (англ или рус),
