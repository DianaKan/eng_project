...
Суть проги: Человек Х, читал книгу/смотрел кино/делал дз, увидел незнакомое английское слово, надо выучить.
            Пользователь открывает программу, сам вводит английские слова и перевод. Все, что он ввел, добавляется в файл(или базу (но у меня сохраняется в файл)).
            Далее он может с этим делать следующее:         есть меню с функциями 1)добавить слово (добавляет английское и перевод)
                                                                                  2)показать все слова
								                                                  3)удалить слово (удаляет одно (вводит именно само слово и удаляется вся строка с этим словом) или все)
								                                                  4)выучить
								                                                  5)выйти			
Не знаю: 1) как удалять слово(строку) из файла (вот тут мне нужно очень помочь( ), я думала создать из содержимого файла массив, найти в этом массиве нужное слово, удалить его, и переписать
            это все заново в этот файл, уже без этого удаленного слова но не могу это сделать
         
		 2) сделать режим изучения (как код написать, а логика вот: 
		                                                            1)из файла(базы) выдается поочередно слово (англ или рус),
																	2)слово выдалось - надо ввести его перевод (и сравнивать слово с введенным с помощью strcmp (но необязательно, 
																	 это я просто только это знаю)
